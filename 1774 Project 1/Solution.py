...
class Solution:
    ...
    def build_conductance_matrix(self):
        ...
        # Building the matrix
        self.cond_matrix[0,0] = self.circuit.g["Rab"]
        self.cond_matrix[0, 1] = self.circuit.g["Rab"]
        self.cond_matrix[1, 0] = self.circuit.g["Rab"]
        self.cond_matrix[1, 1] = self.circuit.g["Rab"] + self.circuit.g["Rab"]
